...
describe("runCheckDrift", () => {
  ...
  it("should include report filename when driftReportName is set", async () => {
    await runCheckDrift({ driftReportName: "my-report" });
  ...
  it("should not include report filename when driftReportName is not set", async () => {
    await runCheckDrift({});
