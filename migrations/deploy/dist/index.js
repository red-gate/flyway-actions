...
function UA() {
  if (Bn) return Qt;
  Bn = 1;
  const A = HA, { kDestroyed: r, kBodyUsed: t, kListeners: g, kBody: e } = WA(), { IncomingMessage: n } = Oe, a = ee, Q = qe, { Blob: l } = re, B = jA, { stringify: s } = Vi, { EventEmitter: i } = pe, { InvalidArgumentError: C } = JA(), { headerNameLowerCasedRecord: I } = Pr(), { tree: c } = so(), [u, p] = process.versions.node.split(".").map((R) => Number(R));
  class m {
    constructor(Z) {
      this[e] = Z, this[t] = !1;
    }
...
function te() {
  if (mn) return pt;
  mn = 1;
  const { Transform: A } = ee, r = Or, { redirectStatusSet: t, referrerPolicySet: g, badPortsSet: e } = ze(), { getGlobalOrigin: n } = ai(), { collectASequenceOfCodePoints: a, collectAnHTTPQuotedString: Q, removeChars: l, parseMIMEType: B } = $A(), { performance: s } = qi, { isBlobLike: i, ReadableStreamFrom: C, isValidHTTPToken: I, normalizedMethodRecordsBase: c } = UA(), u = HA, { isUint8Array: p } = ni, { webidl: m } = XA();
  let S = [], L;
  try {
...
function Ne() {
  ...
  const A = UA(), {
    ...
    extractMimeType: Q,
    utf8DecodeBytes: l
  } = te(), { FormData: B } = Xe(), { kState: s } = Ie(), { webidl: i } = XA(), { Blob: C } = re, I = HA, { isErrored: c, isDisturbed: u } = ee, { isArrayBuffer: p } = ni, { serializeAMimeType: m } = $A(), { multipartFormDataParser: S } = Qo();
  let L;
  try {
...
function Se() {
  if (Jn) return Lt;
  Jn = 1;
  const A = HA, r = qe, t = Oe, g = UA(), { channels: e } = Fe(), n = io(), a = me(), {
...
function ci() {
  if (Vn) return Gt;
  Vn = 1;
  const A = me(), r = Qi(), { kConnected: t, kSize: g, kRunning: e, kPending: n, kQueued: a, kBusy: Q, kFree: l, kUrl: B, kClose: s, kDestroy: i, kDispatch: C } = WA(), I = Eo(), c = /* @__PURE__ */ Symbol("clients"), u = /* @__PURE__ */ Symbol("needDrain"), p = /* @__PURE__ */ Symbol("queue"), m = /* @__PURE__ */ Symbol("closed resolve"), S = /* @__PURE__ */ Symbol("onDrain"), L = /* @__PURE__ */ Symbol("onConnect"), U = /* @__PURE__ */ Symbol("onDisconnect"), b = /* @__PURE__ */ Symbol("onConnectionError"), E = /* @__PURE__ */ Symbol("get dispatcher"), h = /* @__PURE__ */ Symbol("add client"), D = /* @__PURE__ */ Symbol("remove client"), o = /* @__PURE__ */ Symbol("stats");
  class d extends A {
    constructor() {
...
function Co() {
  if (Pn) return xt;
  Pn = 1;
  const A = me(), { kClose: r, kDestroy: t, kClosed: g, kDestroyed: e, kDispatch: n, kNoProxyAgent: a, kHttpProxyAgent: Q, kHttpsProxyAgent: l } = WA(), B = Bi(), s = Ue(), i = {
    "http:": 80,
    "https:": 443
  };
  let C = !1;
...
function ho() {
  ...
  _n = 1;
  const A = HA, { Readable: r } = Ei(), { InvalidArgumentError: t, RequestAbortedError: g } = JA(), e = UA(), { getResolveErrorBodyCallback: n } = Ii(), { AsyncResource: a } = Re;
  class Q extends a {
    constructor(s, i) {
...
function uo() {
  if ($n) return Kt;
  $n = 1;
  const A = HA, { finished: r, PassThrough: t } = ee, { InvalidArgumentError: g, InvalidReturnValueError: e } = JA(), n = UA(), { getResolveErrorBodyCallback: a } = Ii(), { AsyncResource: Q } = Re, { addSignal: l, removeSignal: B } = _e();
  class s extends Q {
    constructor(I, c, u) {
...
function fo() {
  ...
  } = JA(), a = UA(), { AsyncResource: Q } = Re, { addSignal: l, removeSignal: B } = _e(), s = HA, i = /* @__PURE__ */ Symbol("resume");
  class C extends A {
    constructor() {
...
function wo() {
  if (es) return Xt;
  es = 1;
  const { InvalidArgumentError: A, SocketError: r } = JA(), { AsyncResource: t } = Re, g = UA(), { addSignal: e, removeSignal: n } = _e(), a = HA;
  class Q extends t {
    constructor(s, i) {
      if (!s || typeof s != "object")
...
function yo() {
  if (ts) return _t;
  ts = 1;
  const A = HA, { AsyncResource: r } = Re, { InvalidArgumentError: t, SocketError: g } = JA(), e = UA(), { addSignal: n, removeSignal: a } = _e();
  class Q extends r {
    constructor(s, i) {
      if (!s || typeof s != "object")
        throw new t("invalid opts");
...
function hi() {
  ...
  const { promisify: A } = jA, r = Se(), { buildMockDispatch: t } = je(), {
    ...
    kOriginalDispatch: l,
    kConnected: B
  } = Me(), { MockInterceptor: s } = li(), i = WA(), { InvalidArgumentError: C } = JA();
  class I extends r {
    constructor(u, p) {
...
function So() {
  if (us) return cr;
  us = 1;
  const { isIP: A } = qe, { lookup: r } = Zi, t = _r(), { InvalidArgumentError: g, InformationalError: e } = JA(), n = Math.pow(2, 31) - 1;
  class a {
    #A = 0;
    #e = 0;
    #n = /* @__PURE__ */ new Map();
...
function $e() {
  if (ds) return Er;
  ds = 1;
  const { Headers: A, HeadersList: r, fill: t, getHeadersGuard: g, setHeadersGuard: e, setHeadersList: n } = ue(), { extractBody: a, cloneBody: Q, mixinBody: l, hasFinalizationRegistry: B, streamRegistry: s, bodyUnusable: i } = Ne(), C = UA(), I = jA, { kEnumerableProperty: c } = C, {
...
function Le() {
  if (ys) return Cr;
  ys = 1;
  const { extractBody: A, mixinBody: r, cloneBody: t, bodyUnusable: g } = Ne(), { Headers: e, fill: n, HeadersList: a, setHeadersGuard: Q, getHeadersGuard: l, setHeadersList: B, getHeadersList: s } = ue(), { FinalizationRegistry: i } = bo()(), C = UA(), I = jA, {
    isValidHTTPToken: c,
    sameOrigin: u,
...
function At() {
  ...
  const {
    ...
    makeResponse: g,
    fromInnerResponse: e
  } = $e(), { HeadersList: n } = ue(), { Request: a, cloneRequest: Q } = Le(), l = Or, {
    bytesMatch: B,
...
function Lo() {
  ...
  } = fi(), { ProgressEvent: n } = Uo(), { getEncoding: a } = Mo(), { serializeAMimeType: Q, parseMIMEType: l } = $A(), { types: B } = jA, { StringDecoder: s } = Ki, { btoa: i } = re, C = {
    enumerable: !0,
    writable: !1,
    configurable: !1
  };
...
function Go() {
  if (bs) return pr;
  bs = 1;
  const { kConstruct: A } = jr(), { urlEquals: r, getFieldValues: t } = Yo(), { kEnumerableProperty: g, isDisturbed: e } = UA(), { webidl: n } = XA(), { Response: a, cloneResponse: Q, fromInnerResponse: l } = $e(), { Request: B, fromInnerRequest: s } = Le(), { kState: i } = Ie(), { fetching: C } = At(), { urlIsHttpHttpsScheme: I, createDeferredPromise: c, readAllBytes: u } = te(), p = HA;
  class m {
    /**
...
function tt() {
  if (Hs) return Mr;
  Hs = 1;
  const { kReadyState: A, kController: r, kResponse: t, kBinaryType: g, kWebSocketURL: e } = et(), { states: n, opcodes: a } = fe(), { ErrorEvent: Q, createFastMessageEvent: l } = Te(), { isUtf8: B } = re, { collectASequenceOfCodePointsFast: s, removeHTTPWhitespace: i } = $A();
  function C(M) {
...
function wi() {
  ...
  const { uid: A, states: r, sentCloseFrameState: t, emptyBuffer: g, opcodes: e } = fe(), {
    ...
    kReceivedClose: l,
    kResponse: B
  } = et(), { fireEvent: s, failWebsocketConnection: i, isClosing: C, isClosed: I, isEstablished: c, parseExtensions: u } = tt(), { channels: p } = Fe(), { CloseEvent: m } = Te(), { makeRequest: S } = Le(), { fetching: L } = At(), { Headers: U, getHeadersList: b } = ue(), { getDecodeSplit: E } = te(), { WebsocketFrameSend: h } = $r();
  let D;
  try {
...
function Wo() {
  if (qs) return Gr;
  qs = 1;
  const { Writable: A } = ee, r = HA, { parserStates: t, opcodes: g, states: e, emptyBuffer: n, sentCloseFrameState: a } = fe(), { kReadyState: Q, kSentClose: l, kResponse: B, kReceivedClose: s } = et(), { channels: i } = Fe(), {
    isValidStatusCode: C,
    isValidOpcode: I,
...
function Oo() {
  if (Ps) return vr;
  Ps = 1;
  const { webidl: A } = XA(), { URLSerializer: r } = $A(), { environmentSettingsObject: t } = te(), { staticPropertyDescriptors: g, states: e, sentCloseFrameState: n, sendHints: a } = fe(), {
    kWebSocketURL: Q,
    kReadyState: l,
    kController: B,
    kBinaryType: s,
...
function Zo() {
  if (zs) return xr;
  zs = 1;
  const { pipeline: A } = ee, { fetching: r } = At(), { makeRequest: t } = Le(), { webidl: g } = XA(), { EventSourceStream: e } = Po(), { parseMIMEType: n } = $A(), { createFastMessageEvent: a } = Te(), { isNetworkError: Q } = $e(), { delay: l } = yi(), { kEnumerableProperty: B } = UA(), { environmentSettingsObject: s } = te();
  let i = !1;
...
function Ko() {
  if (Xs) return DA;
  Xs = 1;
  const A = Se(), r = Ze(), t = be(), g = Io(), e = Ue(), n = Bi(), a = Co(), Q = lo(), l = JA(), B = UA(), { InvalidArgumentError: s } = l, i = Do(), C = Ke(), I = hi(), c = ko(), u = ui(), p = Ci(), m = zr(), { getGlobalDispatcher: S, setGlobalDispatcher: L } = Xr(), U = _r(), b = Zr(), E = Kr();
  ...
  exec() {
    return ei(this, void 0, void 0, function* () {
      return !pi(this.toolPath) && (this.toolPath.includes("/") || xe && this.toolPath.includes("\\")) && (this.toolPath = ge.resolve(process.cwd(), this.options.cwd || process.cwd(), this.toolPath)), this.toolPath = yield ki(this.toolPath, !0), new Promise((r, t) => ei(this, void 0, void 0, function* () {
        ...
        const n = this._getSpawnFileName(), a = zi.spawn(n, this._getSpawnArgs(g), this._getSpawnOptions(this.options, n));
        let Q = "";
...
`);
  ...
  De(`Running: flyway ${aa(n).join(" ")}`);
  const a = {
    silent: !0,
    ignoreReturnCode: !0,
    listeners: { stdout: t.stdout, stderr: e },
    cwd: r || void 0
  }, Q = await Fi("flyway", n, a), { stdout: l, stderr: B } = g();
  return De(l), { exitCode: Q, stdout: l, stderr: B };
}, ga = async () => {
  ...
  try {
    const r = Ba(A), t = await Si(r, A.workingDirectory);
    if (t.exitCode !== 0) {
      const n = bi(t.stdout);
      throw n?.error?.message && he(n.error.message), new Error(`Flyway migrate failed with exit code ${t.exitCode}`);
    }
    const { migrationsApplied: g, schemaVersion: e } = Ca(t.stdout);
    Ia({ exitCode: t.exitCode, migrationsApplied: g, schemaVersion: e });
  } finally {
    Ni();
  }
}, Ia = (A) => {
  ...
  const A = ie("target-environment") || void 0, r = ie("target-url") || void 0, t = ie("target-user") || void 0, g = ie("target-password") || void 0, e = ie("target-schemas") || void 0, n = ie("target-migration-version") || void 0, a = ie("cherry-pick") || void 0, Q = ra("skip-drift-check"), l = ie("working-directory"), B = l ? ge.resolve(l) : void 0, s = ie("extra-args") || void 0;
  return {
    targetEnvironment: A,
    targetUrl: r,
    targetUser: t,
