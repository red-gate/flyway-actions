...
describe("runCheckDrift", () => {
  ...
  it("should include report filename when undoReportName is set", async () => {
    await runCheckDrift({ undoReportName: "my-report" });
  ...
  it("should not include report filename when undoReportName is not set", async () => {
    await runCheckDrift({});
