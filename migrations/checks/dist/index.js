...
function wi() {
  if (Hn) return Lt;
  Hn = 1;
  const { Blob: A, File: r } = se, { kState: t } = ue(), { webidl: o } = XA();
  class e {
    constructor(c, l, B = {}) {
...
function je() {
  if (Vn) return Tt;
  Vn = 1;
  const { isBlobLike: A, iteratorMixin: r } = re(), { kState: t } = ue(), { kEnumerableProperty: o } = UA(), { FileLike: e, isFileLike: n } = wi(), { webidl: a } = XA(), { File: c } = se, l = $A, B = globalThis.File ?? c;
  class s {
    constructor(I) {
...
function Ne() {
  ...
  const A = UA(), {
    ...
    extractMimeType: c,
    utf8DecodeBytes: l
  } = re(), { FormData: B } = je(), { kState: s } = ue(), { webidl: i } = XA(), { Blob: C } = se, I = HA, { isErrored: Q, isDisturbed: u } = te, { isArrayBuffer: p } = li, { serializeAMimeType: m } = Ae(), { multipartFormDataParser: S } = uo();
  let M;
  try {
...
function we() {
  ...
  const { kConstruct: A } = WA(), { kEnumerableProperty: r } = UA(), {
    ...
    isValidHeaderName: o,
    isValidHeaderValue: e
  } = re(), { webidl: n } = XA(), a = HA, c = $A, l = /* @__PURE__ */ Symbol("headers map"), B = /* @__PURE__ */ Symbol("headers map sorted");
  function s(b) {
...
function et() {
  ...
  const { Headers: A, HeadersList: r, fill: t, getHeadersGuard: o, setHeadersGuard: e, setHeadersList: n } = we(), { extractBody: a, cloneBody: c, mixinBody: l, hasFinalizationRegistry: B, streamRegistry: s, bodyUnusable: i } = Ne(), C = UA(), I = $A, { kEnumerableProperty: Q } = C, {
    ...
    redirectStatusSet: h,
    nullBodyStatus: D
  } = _e(), { kState: g, kHeaders: f } = ue(), { webidl: w } = XA(), { FormData: d } = je(), { URLSerializer: y } = Ae(), { kConstruct: k } = WA(), L = HA, { types: T } = $A, Y = new TextEncoder("utf-8");
  class G {
...
function Le() {
  ...
  const { extractBody: A, mixinBody: r, cloneBody: t, bodyUnusable: o } = Ne(), { Headers: e, fill: n, HeadersList: a, setHeadersGuard: c, getHeadersGuard: l, setHeadersList: B, getHeadersList: s } = we(), { FinalizationRegistry: i } = vo()(), C = UA(), I = $A, {
    ...
    requestCache: h,
    requestDuplex: D
  } = _e(), { kEnumerableProperty: g, normalizedMethodRecordsBase: f, normalizedMethodRecords: w } = C, { kHeaders: d, kSignal: y, kState: k, kDispatcher: L } = ue(), { webidl: T } = XA(), { URLSerializer: Y } = Ae(), { kConstruct: G } = WA(), tA = HA, { getMaxListeners: sA, setMaxListeners: QA, getEventListeners: aA, defaultMaxListeners: lA } = pe, CA = /* @__PURE__ */ Symbol("abortController"), IA = new i(({ signal: x, abort: z }) => {
...
function tt() {
  ...
  const {
    ...
    requestBodyHeader: z,
    subresourceSet: nA
  } = _e(), cA = pe, { Readable: iA, pipeline: fA, finished: LA } = te, { addAbortListener: wA, isErrored: TA, isReadable: FA, bufferToLowerCasedHeaderName: mA } = UA(), { dataURLProcessor: dA, serializeAMimeType: qA, minimizeSupportedMimeType: VA } = Ae(), { getGlobalDispatcher: vA } = sn(), { webidl: _ } = XA(), { STATUS_CODES: R } = Ze, Z = ["GET", "HEAD"], oA = typeof __UNDICI_IS_NODE__ < "u" || typeof esbuildDetection < "u" ? "node" : "undici";
  let BA;
  class hA extends cA {
    constructor(V) {
...
function Wo() {
  ...
  const {
    ...
    kEvents: a,
    kAborted: c
  } = bi(), { webidl: l } = XA(), { kEnumerableProperty: B } = UA();
...
function Oo() {
  if (Vs) return Ur;
  Vs = 1;
  const { kConstruct: A } = an(), { urlEquals: r, getFieldValues: t } = qo(), { kEnumerableProperty: o, isDisturbed: e } = UA(), { webidl: n } = XA(), { Response: a, cloneResponse: c, fromInnerResponse: l } = et(), { Request: B, fromInnerRequest: s } = Le(), { kState: i } = ue(), { fetching: C } = tt(), { urlIsHttpHttpsScheme: I, createDeferredPromise: Q, readAllBytes: u } = re(), p = HA;
  class m {
    /**
...
function Po() {
  if (xs) return Mr;
  xs = 1;
  const { kConstruct: A } = an(), { Cache: r } = Oo(), { webidl: t } = XA(), { kEnumerableProperty: o } = UA();
  class e {
    /**
...
function zo() {
  if (Ps) return Gr;
  Ps = 1;
  const { parseSetCookie: A } = Ko(), { stringify: r } = Ui(), { webidl: t } = XA(), { Headers: o } = we();
  function e(l) {
...
function Te() {
  if (Zs) return Jr;
  Zs = 1;
  const { webidl: A } = XA(), { kEnumerableProperty: r } = UA(), { kConstruct: t } = WA(), { MessagePort: o } = hi;
...
function $o() {
  if (ti) return Zr;
  ti = 1;
  const { webidl: A } = XA(), { URLSerializer: r } = Ae(), { environmentSettingsObject: t } = re(), { staticPropertyDescriptors: o, states: e, sentCloseFrameState: n, sendHints: a } = ye(), {
    kWebSocketURL: c,
    kReadyState: l,
    kController: B,
    kBinaryType: s,
...
function ea() {
  if (si) return Xr;
  si = 1;
  const { pipeline: A } = te, { fetching: r } = tt(), { makeRequest: t } = Le(), { webidl: o } = XA(), { EventSourceStream: e } = Aa(), { parseMIMEType: n } = Ae(), { createFastMessageEvent: a } = Te(), { isNetworkError: c } = et(), { delay: l } = Li(), { kEnumerableProperty: B } = UA(), { environmentSettingsObject: s } = re();
  let i = !1;
...
`);
  ...
  const r = ["check"];
  return A.workingDirectory && r.push(`-workingDirectory=${A.workingDirectory}`), A.extraArgs && r.push(...Ea(A.extraArgs)), r;
}, Hi = (A) => {
  const r = [...cn(A)];
  ...
  const A = _A("target-environment") || void 0, r = _A("target-url") || void 0, t = _A("target-user") || void 0, o = _A("target-password") || void 0, e = _A("target-schemas") || void 0, n = _A("target-migration-version") || void 0, a = _A("cherry-pick") || void 0, c = _A("build-environment") || void 0, l = _A("build-url") || void 0, B = _A("build-user") || void 0, s = _A("build-password") || void 0, i = _A("build-schemas") || void 0, C = le("build-ok-to-erase"), I = le("skip-code-review"), Q = le("skip-drift-check"), u = le("skip-deployment-changes-report"), p = le("skip-deployment-script-review"), m = le("fail-on-code-review"), S = le("fail-on-drift"), M = _A("working-directory"), U = M ? Qe.resolve(M) : void 0, b = _A("extra-args") || void 0;
  return {
    targetEnvironment: A,
    targetUrl: r,
    targetUser: t,
