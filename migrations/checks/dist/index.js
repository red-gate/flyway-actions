...
var ln = () => {
	...
	let n = Bn(e, t);
	if (!n) return;
	let r = await Rn(n, e.workingDirectory), i = vn(r.driftResolutionFolder, e.workingDirectory);
	return (r.driftDetected || r.exitCode === 0 && r.comparisonSupported) && (nn("drift-detected", r.driftDetected.toString()), i !== void 0 && nn("drift-resolution-folder", i)), {
		exitCode: r.exitCode,
		reportPath: r.reportPath
	};
}, Hn = (e) => {
