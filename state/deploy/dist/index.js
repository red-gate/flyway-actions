...
function UA() {
  if (Cn) return ct;
  Cn = 1;
  const A = HA, { kDestroyed: r, kBodyUsed: t, kListeners: g, kBody: e } = WA(), { IncomingMessage: n } = Pe, o = ee, Q = Oe, { Blob: l } = re, B = jA, { stringify: s } = qi, { EventEmitter: i } = pe, { InvalidArgumentError: C } = JA(), { headerNameLowerCasedRecord: I } = Kr(), { tree: c } = ao(), [u, p] = process.versions.node.split(".").map((R) => Number(R));
  class m {
    constructor(Z) {
      this[e] = Z, this[t] = !1;
    }
...
function ze() {
  ...
  function B({ allowH2: C, maxCachedSessions: I, socketPath: c, timeout: u, session: p, ...m }) {
    ...
    return u = u ?? 1e4, C = C ?? !1, function({ hostname: b, host: E, protocol: h, port: D, servername: a, localAddress: d, httpSocket: w }, f) {
      let y;
      if (h === "https:") {
        Q || (Q = Pi), a = a || S.servername || t.getServerName(E) || null;
        const M = a || b;
        r(M);
...
function te() {
  if (bn) return Rt;
  bn = 1;
  const { Transform: A } = ee, r = Zr, { redirectStatusSet: t, referrerPolicySet: g, badPortsSet: e } = Xe(), { getGlobalOrigin: n } = Bi(), { collectASequenceOfCodePoints: o, collectAnHTTPQuotedString: Q, removeChars: l, parseMIMEType: B } = $A(), { performance: s } = Zi, { isBlobLike: i, ReadableStreamFrom: C, isValidHTTPToken: I, normalizedMethodRecordsBase: c } = UA(), u = HA, { isUint8Array: p } = ai, { webidl: m } = XA();
  let S = [], L;
  try {
...
function _e() {
  if (Ln) return mt;
  Ln = 1;
  const { isBlobLike: A, iteratorMixin: r } = te(), { kState: t } = Ce(), { kEnumerableProperty: g } = UA(), { FileLike: e, isFileLike: n } = Ei(), { webidl: o } = XA(), { File: Q } = re, l = jA, B = globalThis.File ?? Q;
  class s {
    constructor(I) {
...
function Eo() {
  if (Tn) return Nt;
  Tn = 1;
  const { isUSVString: A, bufferToLowerCasedHeaderName: r } = UA(), { utf8DecodeBytes: t } = te(), { HTTP_TOKEN_CODEPOINTS: g, isomorphicDecode: e } = $A(), { isFileLike: n } = Ei(), { makeEntry: o } = _e(), Q = HA, { File: l } = re, B = globalThis.File ?? l, s = Buffer.from('form-data; name="'), i = Buffer.from("; filename"), C = Buffer.from("--"), I = Buffer.from(`--\r
`);
  function c(E) {
...
function Ne() {
  ...
  const A = UA(), {
    ...
    extractMimeType: Q,
    utf8DecodeBytes: l
  } = te(), { FormData: B } = _e(), { kState: s } = Ce(), { webidl: i } = XA(), { Blob: C } = re, I = HA, { isErrored: c, isDisturbed: u } = ee, { isArrayBuffer: p } = ai, { serializeAMimeType: m } = $A(), { multipartFormDataParser: S } = Eo();
  let L;
  try {
...
function Se() {
  if (Vn) return Tt;
  Vn = 1;
  const A = HA, r = Oe, t = Pe, g = UA(), { channels: e } = Fe(), n = go(), o = me(), {
...
function Ci() {
  if (qn) return Jt;
  qn = 1;
  const A = me(), r = Ii(), { kConnected: t, kSize: g, kRunning: e, kPending: n, kQueued: o, kBusy: Q, kFree: l, kUrl: B, kClose: s, kDestroy: i, kDispatch: C } = WA(), I = lo(), c = /* @__PURE__ */ Symbol("clients"), u = /* @__PURE__ */ Symbol("needDrain"), p = /* @__PURE__ */ Symbol("queue"), m = /* @__PURE__ */ Symbol("closed resolve"), S = /* @__PURE__ */ Symbol("onDrain"), L = /* @__PURE__ */ Symbol("onConnect"), U = /* @__PURE__ */ Symbol("onDisconnect"), b = /* @__PURE__ */ Symbol("onConnectionError"), E = /* @__PURE__ */ Symbol("get dispatcher"), h = /* @__PURE__ */ Symbol("add client"), D = /* @__PURE__ */ Symbol("remove client"), a = /* @__PURE__ */ Symbol("stats");
  class d extends A {
    constructor() {
...
function uo() {
  if (zn) return Wt;
  zn = 1;
  const A = me(), { kClose: r, kDestroy: t, kClosed: g, kDestroyed: e, kDispatch: n, kNoProxyAgent: o, kHttpProxyAgent: Q, kHttpsProxyAgent: l } = WA(), B = li(), s = Ue(), i = {
    "http:": 80,
    "https:": 443
  };
  let C = !1;
...
function wo() {
  ...
  As = 1;
  const A = HA, { Readable: r } = hi(), { InvalidArgumentError: t, RequestAbortedError: g } = JA(), e = UA(), { getResolveErrorBodyCallback: n } = ui(), { AsyncResource: o } = Re;
  class Q extends o {
    constructor(s, i) {
...
function yo() {
  if (ts) return zt;
  ts = 1;
  const A = HA, { finished: r, PassThrough: t } = ee, { InvalidArgumentError: g, InvalidReturnValueError: e } = JA(), n = UA(), { getResolveErrorBodyCallback: o } = ui(), { AsyncResource: Q } = Re, { addSignal: l, removeSignal: B } = je();
  class s extends Q {
    constructor(I, c, u) {
...
function wi() {
  ...
  const { promisify: A } = jA, r = Se(), { buildMockDispatch: t } = $e(), {
    ...
    kOriginalDispatch: l,
    kConnected: B
  } = Me(), { MockInterceptor: s } = di(), i = WA(), { InvalidArgumentError: C } = JA();
  class I extends r {
    constructor(u, p) {
...
function Le() {
  if (Rs) return lr;
  Rs = 1;
  const { extractBody: A, mixinBody: r, cloneBody: t, bodyUnusable: g } = Ne(), { Headers: e, fill: n, HeadersList: o, setHeadersGuard: Q, getHeadersGuard: l, setHeadersList: B, getHeadersList: s } = fe(), { FinalizationRegistry: i } = Lo()(), C = UA(), I = jA, {
    isValidHTTPToken: c,
    sameOrigin: u,
...
function et() {
  ...
  const {
    ...
    makeResponse: g,
    fromInnerResponse: e
  } = At(), { HeadersList: n } = fe(), { Request: o, cloneRequest: Q } = Le(), l = Zr, {
    bytesMatch: B,
...
function Go() {
  ...
  } = Di(), { ProgressEvent: n } = To(), { getEncoding: o } = Yo(), { serializeAMimeType: Q, parseMIMEType: l } = $A(), { types: B } = jA, { StringDecoder: s } = _i, { btoa: i } = re, C = {
    enumerable: !0,
    writable: !1,
    configurable: !1
  };
...
function Ho() {
  if (Ls) return Rr;
  Ls = 1;
  const { kConstruct: A } = An(), { urlEquals: r, getFieldValues: t } = vo(), { kEnumerableProperty: g, isDisturbed: e } = UA(), { webidl: n } = XA(), { Response: o, cloneResponse: Q, fromInnerResponse: l } = At(), { Request: B, fromInnerRequest: s } = Le(), { kState: i } = Ce(), { fetching: C } = et(), { urlIsHttpHttpsScheme: I, createDeferredPromise: c, readAllBytes: u } = te(), p = HA;
  class m {
    /**
...
function rt() {
  if (Ws) return Lr;
  Ws = 1;
  const { kReadyState: A, kController: r, kResponse: t, kBinaryType: g, kWebSocketURL: e } = tt(), { states: n, opcodes: o } = de(), { ErrorEvent: Q, createFastMessageEvent: l } = Te(), { isUtf8: B } = re, { collectASequenceOfCodePointsFast: s, removeHTTPWhitespace: i } = $A();
  function C(M) {
...
function Po() {
  if (Zs) return Jr;
  Zs = 1;
  const { Writable: A } = ee, r = HA, { parserStates: t, opcodes: g, states: e, emptyBuffer: n, sentCloseFrameState: o } = de(), { kReadyState: Q, kSentClose: l, kResponse: B, kReceivedClose: s } = tt(), { channels: i } = Fe(), {
    isValidStatusCode: C,
    isValidOpcode: I,
...
function Zo() {
  if (Ks) return vr;
  Ks = 1;
  const { WebsocketFrameSend: A } = en(), { opcodes: r, sendHints: t } = de(), g = Ii(), e = Buffer[Symbol.species];
  class n {
    /**
     * @type {FixedQueue}
     */
...
function Ko() {
  ...
  const { webidl: A } = XA(), { URLSerializer: r } = $A(), { environmentSettingsObject: t } = te(), { staticPropertyDescriptors: g, states: e, sentCloseFrameState: n, sendHints: o } = de(), {
    ...
    fireEvent: S
  } = rt(), { establishWebSocketConnection: L, closeWebSocketConnection: U } = Ri(), { ByteParser: b } = Po(), { kEnumerableProperty: E, isBlobLike: h } = UA(), { getGlobalDispatcher: D } = jr(), { types: a } = jA, { ErrorEvent: d, CloseEvent: w } = Te(), { SendQueue: f } = Zo();
...
function zo() {
  if (_s) return xr;
  _s = 1;
  const { Transform: A } = ee, { isASCIINumber: r, isValidLastEventId: t } = ki(), g = [239, 187, 191], e = 10, n = 13, o = 58, Q = 32;
  class l extends A {
    /**
...
function Xo() {
  if (js) return Wr;
  js = 1;
  const { pipeline: A } = ee, { fetching: r } = et(), { makeRequest: t } = Le(), { webidl: g } = XA(), { EventSourceStream: e } = zo(), { parseMIMEType: n } = $A(), { createFastMessageEvent: o } = Te(), { isNetworkError: Q } = At(), { delay: l } = ki(), { kEnumerableProperty: B } = UA(), { environmentSettingsObject: s } = te();
  let i = !1;
...
function _o() {
  if ($s) return DA;
  $s = 1;
  const A = Se(), r = Ke(), t = be(), g = ho(), e = Ue(), n = li(), o = uo(), Q = fo(), l = JA(), B = UA(), { InvalidArgumentError: s } = l, i = ko(), C = ze(), I = wi(), c = No(), u = yi(), p = fi(), m = _r(), { getGlobalDispatcher: S, setGlobalDispatcher: L } = jr(), U = $r(), b = zr(), E = Xr();
  ...
  }, DA.Headers = fe().Headers, DA.Response = At().Response, DA.Request = Le().Request, DA.FormData = _e().FormData, DA.File = globalThis.File ?? re.File, DA.FileReader = Jo().FileReader;
  const { setGlobalOrigin: a, getGlobalOrigin: d } = Bi();
  DA.setGlobalOrigin = a, DA.getGlobalOrigin = d;
  const { CacheStorage: w } = Vo(), { kConstruct: f } = An();
  DA.caches = new w(f);
...
const { chmod: og, copyFile: ag, lstat: gg, mkdir: Qg, open: cg, readdir: jo, rename: Bg, rm: Eg, rmdir: Ig, stat: Or, symlink: Cg, unlink: lg } = qe.promises, he = process.platform === "win32";
  ...
  exec() {
    return ni(this, void 0, void 0, function* () {
      return !mi(this.toolPath) && (this.toolPath.includes("/") || xe && this.toolPath.includes("\\")) && (this.toolPath = ge.resolve(process.cwd(), this.options.cwd || process.cwd(), this.toolPath)), this.toolPath = yield Si(this.toolPath, !0), new Promise((r, t) => ni(this, void 0, void 0, function* () {
        ...
        const n = this._getSpawnFileName(), o = ji.spawn(n, this._getSpawnArgs(g), this._getSpawnOptions(this.options, n));
        let Q = "";
...
`);
  ...
  Ie(`Running: flyway ${ca(n).join(" ")}`);
  const o = {
    silent: !0,
    ignoreReturnCode: !0,
    listeners: { stdout: t.stdout, stderr: e },
    cwd: r || void 0
  }, Q = await bi("flyway", n, o), { stdout: l, stderr: B } = g();
  ...
  try {
    ...
    if (e.exitCode !== 0) {
      ...
      return n?.error?.errorCode === "COMPARISON_DATABASE_NOT_SUPPORTED" ? (Ie(
        "Drift check could not be run because advanced comparison features are not supported for this database type."
      ), We(0), { driftDetected: !1, comparisonSupported: !1 }) : (n?.error?.message && ue(n.error.message), We(e.exitCode), { driftDetected: !1, comparisonSupported: !0 });
    }
  ...
  const A = ie("script-path") || void 0, r = ie("target-environment") || void 0, t = ie("target-url") || void 0, g = ie("target-user") || void 0, e = ie("target-password") || void 0, n = ie("target-schemas") || void 0, o = ia("skip-drift-check"), Q = ie("working-directory"), l = Q ? ge.resolve(Q) : void 0, B = ie("extra-args") || void 0, s = ie("drift-report-name") || void 0;
  return {
    scriptPath: A,
    targetEnvironment: r,
    targetUrl: t,
...
}, wa = (A) => la(Ti(A), A.workingDirectory, A.driftReportName);
  ...
  try {
    ...
    if (da(r), A.edition === "enterprise")
      if (r.skipDriftCheck)
        ...
        const { driftDetected: t, comparisonSupported: g } = await wa(r);
        if (t) {
