...
We want to minimise the number of these tests as they are slow and expensive.
...
These tests should run against SQLite, changes in behaviour based on database type should be covered by the existing Flyway test suite.