...
import We from "node:net";
import qe from "node:http";
...
function zi(A) {
  return pe(A).replace(/%/g, "%25").replace(/\r/g, "%0D").replace(/\n/g, "%0A");
}
function Xi(A) {
...
function _i(A, r) {
  ...
  xe.appendFileSync(t, `${pe(r)}${oe.EOL}`, {
    encoding: "utf8"
  });
}
function ji(A, r) {
  const t = `ghadelimiter_${bi.randomUUID()}`, Q = pe(r);
  if (A.includes(t))
...
function UA() {
  if (cn) return Qt;
  cn = 1;
  const A = HA, { kDestroyed: r, kBodyUsed: t, kListeners: Q, kBody: e } = WA(), { IncomingMessage: n } = qe, a = ee, g = We, { Blob: l } = re, B = jA, { stringify: s } = Ji, { EventEmitter: i } = ye, { InvalidArgumentError: C } = JA(), { headerNameLowerCasedRecord: I } = Or(), { tree: c } = eo(), [u, p] = process.versions.node.split(".").map((R) => Number(R));
  class m {
    constructor(Z) {
      this[e] = Z, this[t] = !1;
    }
...
function Ze() {
  if (hn) return Ct;
  hn = 1;
  const A = We, r = HA, t = UA(), { InvalidArgumentError: Q, ConnectTimeoutError: e } = JA(), n = ii();
  function a() {
  }
  let g, l;
...
function te() {
  if (Fn) return Dt;
  Fn = 1;
  const { Transform: A } = ee, r = qr, { redirectStatusSet: t, referrerPolicySet: Q, badPortsSet: e } = Ke(), { getGlobalOrigin: n } = oi(), { collectASequenceOfCodePoints: a, collectAnHTTPQuotedString: g, removeChars: l, parseMIMEType: B } = $A(), { performance: s } = Vi, { isBlobLike: i, ReadableStreamFrom: C, isValidHTTPToken: I, normalizedMethodRecordsBase: c } = UA(), u = HA, { isUint8Array: p } = ri, { webidl: m } = XA();
  let S = [], L;
  try {
...
function ai() {
  ...
  return Rt = { FileLike: e, isFileLike: n }, Rt;
}
var kt, Sn;
function ze() {
  if (Sn) return kt;
  ...
  return kt = { FormData: s, makeEntry: i }, kt;
}
var Ft, bn;
function io() {
  if (bn) return Ft;
  bn = 1;
  const { isUSVString: A, bufferToLowerCasedHeaderName: r } = UA(), { utf8DecodeBytes: t } = te(), { HTTP_TOKEN_CODEPOINTS: Q, isomorphicDecode: e } = $A(), { isFileLike: n } = ai(), { makeEntry: a } = ze(), g = HA, { File: l } = re, B = globalThis.File ?? l, s = Buffer.from('form-data; name="'), i = Buffer.from("; filename"), C = Buffer.from("--"), I = Buffer.from(`--\r
`);
  function c(E) {
...
function Fe() {
  ...
  const A = UA(), {
    ...
    extractMimeType: g,
    utf8DecodeBytes: l
  } = te(), { FormData: B } = ze(), { kState: s } = Ie(), { webidl: i } = XA(), { Blob: C } = re, I = HA, { isErrored: c, isDisturbed: u } = ee, { isArrayBuffer: p } = ri, { serializeAMimeType: m } = $A(), { multipartFormDataParser: S } = io();
  let L;
  try {
...
function oo() {
  if (Mn) return Nt;
  Mn = 1;
  const A = HA, r = UA(), { channels: t } = Re(), Q = ii(), {
...
function Pr() {
  if (Tn) return bt;
  Tn = 1;
  const A = UA(), { kBodyUsed: r } = WA(), t = HA, { InvalidArgumentError: Q } = JA(), e = ye, n = [300, 301, 302, 303, 307, 308], a = /* @__PURE__ */ Symbol("body");
  class g {
    constructor(I) {
      this[a] = I, this[r] = !1;
    }
...
function me() {
  if (Gn) return Mt;
  Gn = 1;
  const A = HA, r = We, t = qe, Q = UA(), { channels: e } = Re(), n = to(), a = ke(), {
...
function gi() {
  if (Hn) return Yt;
  Hn = 1;
  const A = ke(), r = Qi(), { kConnected: t, kSize: Q, kRunning: e, kPending: n, kQueued: a, kBusy: g, kFree: l, kUrl: B, kClose: s, kDestroy: i, kDispatch: C } = WA(), I = Qo(), c = /* @__PURE__ */ Symbol("clients"), u = /* @__PURE__ */ Symbol("needDrain"), p = /* @__PURE__ */ Symbol("queue"), m = /* @__PURE__ */ Symbol("closed resolve"), S = /* @__PURE__ */ Symbol("onDrain"), L = /* @__PURE__ */ Symbol("onConnect"), U = /* @__PURE__ */ Symbol("onDisconnect"), b = /* @__PURE__ */ Symbol("onConnectionError"), E = /* @__PURE__ */ Symbol("get dispatcher"), h = /* @__PURE__ */ Symbol("add client"), D = /* @__PURE__ */ Symbol("remove client"), o = /* @__PURE__ */ Symbol("stats");
  class f extends A {
    constructor() {
...
function Ne() {
  ...
  const {
    ...
    InvalidArgumentError: a
  } = JA(), g = UA(), { kUrl: l, kInterceptors: B } = WA(), s = Ze(), i = /* @__PURE__ */ Symbol("options"), C = /* @__PURE__ */ Symbol("connections"), I = /* @__PURE__ */ Symbol("factory");
  function c(p, m) {
    return new n(p, m);
  }
  class u extends A {
...
function go() {
  ...
  const {
    ...
    kRemoveClient: a,
    kGetDispatcher: g
  } = gi(), l = Ne(), { kUrl: B, kInterceptors: s } = WA(), { parseOrigin: i } = UA(), C = /* @__PURE__ */ Symbol("factory"), I = /* @__PURE__ */ Symbol("options"), c = /* @__PURE__ */ Symbol("kGreatestCommonDivisor"), u = /* @__PURE__ */ Symbol("kCurrentWeight"), p = /* @__PURE__ */ Symbol("kIndex"), m = /* @__PURE__ */ Symbol("kWeight"), S = /* @__PURE__ */ Symbol("kMaxWeightPerServer"), L = /* @__PURE__ */ Symbol("kErrorPenalty");
  function U(h, D) {
    if (h === 0) return D;
    for (; D !== 0; ) {
      const o = D;
...
function Se() {
  if (Wn) return vt;
  Wn = 1;
  const { InvalidArgumentError: A } = JA(), { kClients: r, kRunning: t, kClose: Q, kDestroy: e, kDispatch: n, kInterceptors: a } = WA(), g = ke(), l = Ne(), B = me(), s = UA(), i = Zr(), C = /* @__PURE__ */ Symbol("onConnect"), I = /* @__PURE__ */ Symbol("onDisconnect"), c = /* @__PURE__ */ Symbol("onConnectionError"), u = /* @__PURE__ */ Symbol("maxRedirections"), p = /* @__PURE__ */ Symbol("onDrain"), m = /* @__PURE__ */ Symbol("factory"), S = /* @__PURE__ */ Symbol("options");
  function L(b, E) {
...
function ci() {
  if (qn) return Ht;
  qn = 1;
  const { kProxy: A, kClose: r, kDestroy: t, kDispatch: Q, kInterceptors: e } = WA(), { URL: n } = xi, a = Se(), g = Ne(), l = ke(), { InvalidArgumentError: B, RequestAbortedError: s, SecureProxyConnectionError: i } = JA(), C = Ze(), I = me(), c = /* @__PURE__ */ Symbol("proxy agent"), u = /* @__PURE__ */ Symbol("proxy client"), p = /* @__PURE__ */ Symbol("proxy headers"), m = /* @__PURE__ */ Symbol("request tls settings"), S = /* @__PURE__ */ Symbol("proxy tls settings"), L = /* @__PURE__ */ Symbol("connect endpoint function"), U = /* @__PURE__ */ Symbol("tunnel proxy");
  function b(y) {
...
function co() {
  if (On) return Vt;
  On = 1;
  const A = ke(), { kClose: r, kDestroy: t, kClosed: Q, kDestroyed: e, kDispatch: n, kNoProxyAgent: a, kHttpProxyAgent: g, kHttpsProxyAgent: l } = WA(), B = ci(), s = Se(), i = {
    "http:": 80,
    "https:": 443
  };
  let C = !1;
...
function Bi() {
  ...
  return qt = { Readable: u, chunksDecode: U }, qt;
}
var Ot, zn;
function Ei() {
  if (zn) return Ot;
...
function Eo() {
  ...
  Xn = 1;
  const A = HA, { Readable: r } = Bi(), { InvalidArgumentError: t, RequestAbortedError: Q } = JA(), e = UA(), { getResolveErrorBodyCallback: n } = Ei(), { AsyncResource: a } = De;
  class g extends a {
    constructor(s, i) {
  ...
  return Je.exports = l, Je.exports.RequestHandler = g, Je.exports;
}
var Pt, _n;
function Xe() {
  if (_n) return Pt;
...
function Io() {
  if (jn) return Zt;
  jn = 1;
  const A = HA, { finished: r, PassThrough: t } = ee, { InvalidArgumentError: Q, InvalidReturnValueError: e } = JA(), n = UA(), { getResolveErrorBodyCallback: a } = Ei(), { AsyncResource: g } = De, { addSignal: l, removeSignal: B } = Xe();
  class s extends g {
    constructor(I, c, u) {
...
function Co() {
  ...
  } = JA(), a = UA(), { AsyncResource: g } = De, { addSignal: l, removeSignal: B } = Xe(), s = HA, i = /* @__PURE__ */ Symbol("resume");
  class C extends A {
    constructor() {
...
function lo() {
  if (As) return zt;
  As = 1;
  const { InvalidArgumentError: A, SocketError: r } = JA(), { AsyncResource: t } = De, Q = UA(), { addSignal: e, removeSignal: n } = Xe(), a = HA;
  class g extends t {
    constructor(s, i) {
      if (!s || typeof s != "object")
...
function ho() {
  if (es) return Xt;
  es = 1;
  const A = HA, { AsyncResource: r } = De, { InvalidArgumentError: t, SocketError: Q } = JA(), e = UA(), { addSignal: n, removeSignal: a } = Xe();
  class g extends r {
    constructor(s, i) {
      if (!s || typeof s != "object")
        throw new t("invalid opts");
...
function _e() {
  ...
  const { MockNotMatchedError: A } = Ii(), {
    ...
    kOrigin: e,
    kGetNetConnect: n
  } = be(), { buildURL: a } = UA(), { STATUS_CODES: g } = qe, {
    types: {
      isPromise: l
    }
  } = jA;
...
function Ci() {
  if (is) return ve;
  is = 1;
  const { getResponseData: A, buildKey: r, addMockDispatch: t } = _e(), {
    kDispatches: Q,
    kDispatchKey: e,
    kDefaultHeaders: n,
    kDefaultTrailers: a,
    kContentLength: g,
    kMockDispatch: l
  } = be(), { InvalidArgumentError: B } = JA(), { buildURL: s } = UA();
  class i {
    constructor(c) {
      this[l] = c;
    }
...
function li() {
  if (os) return Ar;
  os = 1;
  const { promisify: A } = jA, r = me(), { buildMockDispatch: t } = _e(), {
    kDispatches: Q,
    kMockAgent: e,
    kClose: n,
    kOriginalClose: a,
    ...
    kOriginalDispatch: l,
    kConnected: B
  } = be(), { MockInterceptor: s } = Ci(), i = WA(), { InvalidArgumentError: C } = JA();
  class I extends r {
    constructor(u, p) {
...
function hi() {
  if (as) return er;
  as = 1;
  const { promisify: A } = jA, r = Ne(), { buildMockDispatch: t } = _e(), {
    kDispatches: Q,
    kMockAgent: e,
    kClose: n,
    kOriginalClose: a,
...
function yo() {
  ...
  const { kClients: A } = WA(), r = Se(), {
    ...
    kOptions: B,
    kFactory: s
  } = be(), i = li(), C = hi(), { matchValue: I, buildMockOptions: c } = _e(), { InvalidArgumentError: u, UndiciError: p } = JA(), m = Pe(), S = fo(), L = wo();
  class U extends m {
    constructor(E) {
...
function ko() {
  if (hs) return gr;
  hs = 1;
  const { isIP: A } = We, { lookup: r } = qi, t = Xr(), { InvalidArgumentError: Q, InformationalError: e } = JA(), n = Math.pow(2, 31) - 1;
  class a {
    #A = 0;
    #e = 0;
    #n = /* @__PURE__ */ new Map();
...
function je() {
  ...
  const { Headers: A, HeadersList: r, fill: t, getHeadersGuard: Q, setHeadersGuard: e, setHeadersList: n } = he(), { extractBody: a, cloneBody: g, mixinBody: l, hasFinalizationRegistry: B, streamRegistry: s, bodyUnusable: i } = Fe(), C = UA(), I = jA, { kEnumerableProperty: c } = C, {
    ...
    redirectStatusSet: h,
    nullBodyStatus: D
  } = Ke(), { kState: o, kHeaders: f } = Ie(), { webidl: w } = XA(), { FormData: d } = ze(), { URLSerializer: y } = $A(), { kConstruct: k } = WA(), M = HA, { types: T } = jA, Y = new TextEncoder("utf-8");
  class G {
...
function Ue() {
  if (ws) return Ir;
  ws = 1;
  const { extractBody: A, mixinBody: r, cloneBody: t, bodyUnusable: Q } = Fe(), { Headers: e, fill: n, HeadersList: a, setHeadersGuard: g, getHeadersGuard: l, setHeadersList: B, getHeadersList: s } = he(), { FinalizationRegistry: i } = Fo()(), C = UA(), I = jA, {
    isValidHTTPToken: c,
    sameOrigin: u,
    ...
    requestCache: h,
    requestDuplex: D
  } = Ke(), { kEnumerableProperty: o, normalizedMethodRecordsBase: f, normalizedMethodRecords: w } = C, { kHeaders: d, kSignal: y, kState: k, kDispatcher: M } = Ie(), { webidl: T } = XA(), { URLSerializer: Y } = $A(), { kConstruct: G } = WA(), tA = HA, { getMaxListeners: sA, setMaxListeners: gA, getEventListeners: aA, defaultMaxListeners: lA } = ye, CA = /* @__PURE__ */ Symbol("abortController"), IA = new i(({ signal: x, abort: z }) => {
...
function $e() {
  ...
  const {
    ...
    makeResponse: Q,
    fromInnerResponse: e
  } = je(), { HeadersList: n } = he(), { Request: a, cloneRequest: g } = Ue(), l = qr, {
    bytesMatch: B,
    ...
    createInflate: CA,
    extractMimeType: IA
  } = te(), { kState: pA, kDispatcher: yA } = Ie(), j = HA, { safelyExtractBody: P, extractBody: rA } = Fe(), {
    redirectStatusSet: v,
    nullBodyStatus: O,
    safeMethodsSet: x,
    requestBodyHeader: z,
    subresourceSet: nA
  } = Ke(), cA = ye, { Readable: iA, pipeline: fA, finished: LA } = ee, { addAbortListener: wA, isErrored: TA, isReadable: FA, bufferToLowerCasedHeaderName: mA } = UA(), { dataURLProcessor: dA, serializeAMimeType: qA, minimizeSupportedMimeType: VA } = $A(), { getGlobalDispatcher: vA } = zr(), { webidl: _ } = XA(), { STATUS_CODES: R } = qe, Z = ["GET", "HEAD"], oA = typeof __UNDICI_IS_NODE__ < "u" || typeof esbuildDetection < "u" ? "node" : "undici";
  let BA;
  class hA extends cA {
    constructor(V) {
    ...
    function ne({ body: SA }) {
      ...
      return new Promise((OA, Qe) => Ae.dispatch(
        ...
        },
        {
          ...
          onHeaders(ZA, _A, tt, Le) {
            if (ZA < 200)
              return;
            let ce = "";
            const Te = new n();
            for (let se = 0; se < _A.length; se += 2)
              Te.append(mA(_A[se]), _A[se + 1].toString("latin1"), !0);
            ce = Te.get("location", !0), this.body = new iA({ read: tt });
            const Ce = [], Si = ce && W.redirect === "follow" && v.has(ZA);
            if (W.method !== "HEAD" && W.method !== "CONNECT" && !O.includes(ZA) && !Si) {
              const se = Te.get("content-encoding", !0), Ye = se ? se.toLowerCase().split(",") : [], en = 5;
              if (Ye.length > en)
            ...
            return OA({
              ...
              statusText: Le,
              headersList: Te,
              body: Ce.length ? fA(this.body, ...Ce, (se) => {
                se && this.onError(se);
          ...
          onUpgrade(ZA, _A, tt) {
            ...
            for (let ce = 0; ce < _A.length; ce += 2)
              Le.append(mA(_A[ce]), _A[ce + 1].toString("latin1"), !0);
            return OA({
              status: ZA,
              statusText: R[ZA],
              headersList: Le,
...
function Mo() {
  if (Ss) return Dr;
  Ss = 1;
  const { kConstruct: A } = _r(), { urlEquals: r, getFieldValues: t } = Uo(), { kEnumerableProperty: Q, isDisturbed: e } = UA(), { webidl: n } = XA(), { Response: a, cloneResponse: g, fromInnerResponse: l } = je(), { Request: B, fromInnerRequest: s } = Ue(), { kState: i } = Ie(), { fetching: C } = $e(), { urlIsHttpHttpsScheme: I, createDeferredPromise: c, readAllBytes: u } = te(), p = HA;
  class m {
    /**
...
function Go() {
  if (Ts) return mr;
  Ts = 1;
  const { parseSetCookie: A } = Yo(), { stringify: r } = di(), { webidl: t } = XA(), { Headers: Q } = he();
  function e(l) {
...
function et() {
  if (vs) return Ur;
  vs = 1;
  const { kReadyState: A, kController: r, kResponse: t, kBinaryType: Q, kWebSocketURL: e } = At(), { states: n, opcodes: a } = ue(), { ErrorEvent: g, createFastMessageEvent: l } = Me(), { isUtf8: B } = re, { collectASequenceOfCodePointsFast: s, removeHTTPWhitespace: i } = $A();
  function C(M) {
...
function fi() {
  ...
  const { uid: A, states: r, sentCloseFrameState: t, emptyBuffer: Q, opcodes: e } = ue(), {
    ...
    kReceivedClose: l,
    kResponse: B
  } = At(), { fireEvent: s, failWebsocketConnection: i, isClosing: C, isClosed: I, isEstablished: c, parseExtensions: u } = et(), { channels: p } = Re(), { CloseEvent: m } = Me(), { makeRequest: S } = Ue(), { fetching: L } = $e(), { Headers: U, getHeadersList: b } = he(), { getDecodeSplit: E } = te(), { WebsocketFrameSend: h } = jr();
  let D;
  try {
...
function Jo() {
  if (xs) return Tr;
  xs = 1;
  const { createInflateRaw: A, Z_DEFAULT_WINDOWBITS: r } = qr, { isValidClientWindowBits: t } = et(), Q = Buffer.from([0, 0, 255, 255]), e = /* @__PURE__ */ Symbol("kBuffer"), n = /* @__PURE__ */ Symbol("kLength");
  class a {
  ...
  return Tr = { PerMessageDeflate: a }, Tr;
}
var Yr, Ws;
function vo() {
  if (Ws) return Yr;
  Ws = 1;
  const { Writable: A } = ee, r = HA, { parserStates: t, opcodes: Q, states: e, emptyBuffer: n, sentCloseFrameState: a } = ue(), { kReadyState: g, kSentClose: l, kResponse: B, kReceivedClose: s } = At(), { channels: i } = Re(), {
    isValidStatusCode: C,
    isValidOpcode: I,
  ...
  } = et(), { WebsocketFrameSend: U } = jr(), { closeWebSocketConnection: b } = fi(), { PerMessageDeflate: E } = Jo();
  class h extends A {
    #A = [];
    #e = 0;
    #n = !1;
...
function Ho() {
  if (qs) return Gr;
  qs = 1;
  const { WebsocketFrameSend: A } = jr(), { opcodes: r, sendHints: t } = ue(), Q = Qi(), e = Buffer[Symbol.species];
  class n {
    /**
     * @type {FixedQueue}
     */
...
function Vo() {
  ...
  const { webidl: A } = XA(), { URLSerializer: r } = $A(), { environmentSettingsObject: t } = te(), { staticPropertyDescriptors: Q, states: e, sentCloseFrameState: n, sendHints: a } = ue(), {
    ...
    fireEvent: S
  } = et(), { establishWebSocketConnection: L, closeWebSocketConnection: U } = fi(), { ByteParser: b } = vo(), { kEnumerableProperty: E, isBlobLike: h } = UA(), { getGlobalDispatcher: D } = zr(), { types: o } = jA, { ErrorEvent: f, CloseEvent: w } = Me(), { SendQueue: d } = Ho();
...
function Wo() {
  if (Ks) return Vr;
  Ks = 1;
  const { pipeline: A } = ee, { fetching: r } = $e(), { makeRequest: t } = Ue(), { webidl: Q } = XA(), { EventSourceStream: e } = xo(), { parseMIMEType: n } = $A(), { createFastMessageEvent: a } = Me(), { isNetworkError: g } = je(), { delay: l } = wi(), { kEnumerableProperty: B } = UA(), { environmentSettingsObject: s } = te();
  let i = !1;
...
function qo() {
  if (zs) return DA;
  zs = 1;
  const A = me(), r = Pe(), t = Ne(), Q = go(), e = Se(), n = ci(), a = co(), g = Bo(), l = JA(), B = UA(), { InvalidArgumentError: s } = l, i = uo(), C = Ze(), I = li(), c = yo(), u = hi(), p = Ii(), m = Kr(), { getGlobalDispatcher: S, setGlobalDispatcher: L } = zr(), U = Xr(), b = Pr(), E = Zr();
  ...
  }, DA.Headers = he().Headers, DA.Response = je().Response, DA.Request = Ue().Request, DA.FormData = ze().FormData, DA.File = globalThis.File ?? re.File, DA.FileReader = bo().FileReader;
...
const { chmod: AQ, copyFile: eQ, lstat: tQ, mkdir: rQ, open: nQ, readdir: Oo, rename: sQ, rm: iQ, rmdir: oQ, stat: xr, symlink: aQ, unlink: QQ } = xe.promises, le = process.platform === "win32";
...
class zo extends ti.EventEmitter {
  ...
  exec() {
    return Ai(this, void 0, void 0, function* () {
      return !Di(this.toolPath) && (this.toolPath.includes("/") || He && this.toolPath.includes("\\")) && (this.toolPath = ae.resolve(process.cwd(), this.options.cwd || process.cwd(), this.toolPath)), this.toolPath = yield Ri(this.toolPath, !0), new Promise((r, t) => Ai(this, void 0, void 0, function* () {
...
function $o(A, r = {}) {
  Oe("error", si(r), A instanceof Error ? A.toString() : A);
}
function Fi(A, r = {}) {
  Oe("warning", si(r), A instanceof Error ? A.toString() : A);
}
function we(A) {
...
const Aa = () => {
  ...
  const r = [];
  return A.environment && r.push(`-environment=${A.environment}`), A.url && r.push(`-url=${A.url}`), A.user && r.push(`-user=${A.user}`), A.password && r.push(`-password=${A.password}`), A.workingDirectory && r.push(`-workingDirectory=${A.workingDirectory}`), A.extraArgs && r.push(...na(A.extraArgs)), r;
}, na = (A) => {
  const r = [];
  let t = "", Q = !1, e = "";
  for (let n = 0; n < A.length; n++) {
  ...
  Ve("drift-detected", A.toString());
}, ga = (A) => {
  Ve("exit-code", A.exitCode.toString()), Ve("migrations-applied", A.migrationsApplied.toString()), Ve("schema-version", A.schemaVersion);
}, ca = (A) => ["check", "-drift", ...mi(A)], Ba = async (A) => {
  we("Running drift check before migration...");
  const r = ca(A), t = await Ni(r, A.workingDirectory);
  t.stdout && we(t.stdout), t.stderr && Fi(t.stderr);
  const Q = t.exitCode !== 0;
  return Qa(Q), Q || we("No drift detected. Proceeding with migration."), Q;
}, Ea = (A) => {
  ...
  const r = Ea(A), t = await Ni(r, A.workingDirectory);
  t.stdout && we(t.stdout), t.stderr && Fi(t.stderr);
  const { migrationsApplied: Q, schemaVersion: e } = aa(t.stdout);
  if (ga({
    exitCode: t.exitCode,
    migrationsApplied: Q,
    schemaVersion: e
